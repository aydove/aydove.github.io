...
//1：特殊情况单独处理  
 ...
 //2：小型积木搭建（初始化） 
	...
	//问题来了，为什么要这里的n=3和上面n=3好像不一样呢？因为，当长度只有3的时候，我们还必须剪一刀，所以n=3时乘积最大为2；可是如果我们把一个更长的绳子分出一段为3，我们就没有**必须剪一刀**这个约束，所以3作为一个小段单元是可以成为大乘shu3
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwOTQ1NTc1NiwxODgzMDg2MDk4LC0xOD
QzMzI4NDddfQ==
-->