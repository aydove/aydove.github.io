...
递归返回的条件是`return nullptr`，也就是说当`InOrderRecur(treeNode.LChild);` 这句话结束后`return nullptr`，所以本题`TreeNode* node = KthNode(root->left,k);`，
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NDk2MzY3NiwxNDk1NTkwMDM5LC0xOT
M4MzQ4MjQ2LDE4NTk2OTczMzYsMTEyMDU4NTg0Ml19
-->