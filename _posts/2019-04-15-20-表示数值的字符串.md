...
```
- 不能理解这里‘isnum= scanunsignint(&str)\|\|isnum;’顺序也不能错是为啥啊啊啊啊  ，这里好像是如果isnum是true，那么程序不会执行后面的scan函数而是直接判断为true（因为是或条件），然后走到底下retrue
- 注意before前面的*
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MzQxNzYyMiwtMTA2OTEyMzUzLDE4MT
I3ODk1NywxMzYzMTc3OTc1LC04NzY5Njg0OTMsMTAzMTMyODk3
LC0xNTk4MzA0MzEsNjUyNTU3Njg4LDcxNjg1MTcyMF19
-->