...
> set、multiset都是集合类，差别在与set中不允许有重复元素，multiset中允许有重复元素。这两个类有很多现成的函数可以用。详情可以参考：
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2ODE4MjgxMCwxMjE2MDM5Mzc0LDg5OD
g1NzM1MCwxOTc2OTQzODk4LC04NzczNjc5MjBdfQ==
-->