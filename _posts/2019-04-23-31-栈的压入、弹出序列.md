...
//1.1 如果下一个pop数字不在辅助栈的栈顶，则把push序列中还没有入栈的数字压入辅助栈，直到把下一个需要弹出的数字位于栈顶  
 ...
 //这里需要注意的是，这里会发生越界，但是也没报错。。但是必须要越界，因为即便是push到最后一个也不能认为人家错了，必须是发现push了一个越界的，也就是id++之后的id>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQyNzE2ODYwLC0xMTc5NDE1NzU3LC0xMT
I2NDI3ODE4LDEyMzEwNDYzODMsLTE1NDc4OTY4ODIsMzAxOTM3
NTE0LC00MzAyNDg0MDIsLTE4NjA4NDE3MDAsLTIwNTUwMTg5NT
YsLTE4MjE2OTI5NDEsLTE5MjMzMDM1ODIsMjAxNjQxMDMzNV19
