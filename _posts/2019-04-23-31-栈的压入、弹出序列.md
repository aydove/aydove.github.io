...
//1.1 如果下一个pop数字不在辅助栈的栈顶，则把push序列中还没有入栈的数字压入辅助栈，直到把下一个需要弹出的数字位于栈顶  
 ...
 //这里需要注意的是，这里会发生越界，但是也没报错。。但是必须要越界，因为即便是push到最后一个也不能认为人家错了，必须是发现push了一个越界的，也就是id++之后的id>pushV.size(),我们才认为出错；
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzQ5MzQ1OTIsLTExNzk0MTU3NTcsLT
ExMjY0Mjc4MTgsMTIzMTA0NjM4MywtMTU0Nzg5Njg4MiwzMDE5
Mzc1MTQsLTQzMDI0ODQwMiwtMTg2MDg0MTcwMCwtMjA1NTAxOD
k1NiwtMTgyMTY5Mjk0MSwtMTkyMzMwMzU4MiwyMDE2NDEwMzM1
XX0=
-->